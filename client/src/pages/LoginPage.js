...
const LoginPage = () => {
  ...
  const requestOtp = async () => {
    try {
      ...
      const response = await axios.post('https://vanamalaclinicserver.onrender.com/request-otp', { phone });
  ...
  const handleLogin = async () => {
    try {
      ...
      // Verify the OTP
      const response = await axios.post('https://vanamalaclinicserver.onrender.com/verify-otp', { phone: phoneNumber, otp: enteredOtp });
      if (response.data.success) {
